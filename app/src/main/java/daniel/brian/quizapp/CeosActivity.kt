...
import daniel.brian.quizapp.databinding.ActivityCeosBinding

class CeosActivity : AppCompatActivity() , View.OnClickListener{

    private lateinit var binding: ActivityCeosBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityCeosBinding.inflate(layoutInflater)
